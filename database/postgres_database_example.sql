...
SELECT pg_catalog.setval('driver_sensori_id_driver_seq', 1, false);
...
SELECT pg_catalog.setval('misurazioni_id_misurazione_seq', 1, false);
...
1	Test	Sensore di test	\N	t	t	\N	\N
\.
